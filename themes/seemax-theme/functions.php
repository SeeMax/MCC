...
function theme_style() {
  wp_enqueue_style( 'google-fonts', "https://fonts.googleapis.com/css2?family=Roboto:wght@100;300;400&display=swap", false );
...
//   if( $postType == 'events' || $postType == 'news' || || $postType == page)
//       return false;
...
function register_acf_block_types() {
  ...
  acf_register_block_type(array(
    ...
    'mode'               => 'preview',
    'align'             => 'full',
    'render_template'   => get_template_directory() . '/blocks/layout/half-section/half-section.php',
    'enqueue_style'     => get_template_directory_uri() . '/blocks/layout/half-section/half-section.css',
    'enqueue_script'    => get_template_directory_uri() . '/blocks/dist/js/half-section.js',
    'enqueue_assets' => function(){
      add_editor_style('/blocks/layout/half-section/half-section.css');
    },
  ));
  ...
  acf_register_block_type(array(
    ...
    'category'          => 'layout',
    'icon'              => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" ><path d="M12,0H0v24h7.4h1.9H12h2.7h1.9H24V0H12z M2,2h20v7.7h-5.4h-1.9H9.3H7.4H1.9L2,2L2,2z M1.9,22V11.6h5.4V22H1.9z M9.3,22V11.6 h5.4V22H9.3z M16.6,22V11.6H22V22H16.6z"/></svg>',
    'keywords'          => array( 'side', 'image' ),
    'mode'               => 'preview',
    'align'             => 'full',
    ...
    'enqueue_assets' => function(){
      add_editor_style('/blocks/layout/three-column-section/three-column-section.css');
    },
  ));
